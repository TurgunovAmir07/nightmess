...
build-webapp:
	docker build --build-arg VITE_SERVER_URL=${VITE_SERVER_URL} --build-arg VITE_APP_TYPE=telegram -t ${DOCKER_LOGIN}/${DOCKER_WEBAPP_NAME}:deploy -f ./apps/client/Dockerfile ./apps/client
push-client:
