      ...
      <div className={cl.root}>
        ...
        <div className={cl.root__wrapper}>
          ...
          <span className={cl.root__wrapper__text}>
            Скорость и стоимость доставки <br /> зависит от выбранного вами{' '}
            <br /> способа доставки.
          </span>
          <span className={cl.root__wrapper__text}>
            Вы также можете следить за <br /> статусом заказа в личном кабинете.
          </span>
        </div>
        <div className={cl.root__wrapper}>
          <h3 className={cl.root__wrapper_title}>
            Обмен<span className={cl.root__wrapper__text_info}>\</span>возвраты:
          </h3>
          <span className={cl.root__wrapper__text}>
            В случае брака производится обмен <br /> вещи из наличия, либо
            возврат <br />
            денежных средств.
          </span>
          <span className={cl.root__wrapper__text}>
            По любым вопросам пишите <br /> в поддержку <br /> в телеграмм:{' '}
            <span className={cl.root__wrapper__text_info}>@nightmessworld</span>
          </span>
        </div>
        <div className={cl.root__wrapper}>
