        ...
        <form onSubmit={handleSubmit(onSubmit)} className={cl.root__content}>
          ...
          <div className={cl.root__content__main}>
            {settingsFieldsArr.map((item, index) =>
              item.isRadio ? (
                <div key={index} className={cl.root__content__main__radioWrap}>
                  <label
                    className={`${cl.root__content__main__radioWrap__label} ${
                      errors[item.id] &&
                  ...
                  <span
                    className={cl.root__content__main__radioWrap__label_error}
                  >
